...
from contentBased3 import get_recommendations,get_random_movies,search_nearest_movies,changeStr
app = Flask(__name__)
...
def index():
    if request.method == 'GET':
        ...
        return render_template('index3.html',index_list=index_list, html=html)
        ...
        if movieName is None:  # 没输入电影名
            ...
            movieName = search_nearest_movies(changeStr(movieName))
            if movieName == '':
